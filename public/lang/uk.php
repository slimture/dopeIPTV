...
return [
    ...
    // ---- Help page ----
    "nav_help" => "Довідка",
    "help_eyebrow" => "Довідка",
    "help_h1" => "Як користуватися dopeIPTV",
    "help_intro" => "Короткі відповіді, згруповані за тим, що ви хочете зробити. Шукайте або відкрийте розділ.",
    "help_search_ph" => "Пошук у довідці…",
    "help_toc" => "Розділи",
    "help_no_hits" => "Нічого не знайдено. Спробуйте коротше слово або запитайте на GitHub.",
];
