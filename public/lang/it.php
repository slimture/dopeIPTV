...
return [
    ...
    "os_help_macos"   => "Due immagini: una per Apple Silicon (serie M), una per i Mac Intel. Non sei sicuro? Menu Apple → Informazioni su questo Mac. Richiede macOS 15 o successivo.",
