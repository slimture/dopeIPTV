...
return [
    ...
    "dl_latest"  => "ล่าสุด",
    "dl_total_suffix" => "ดาวน์โหลดทั้งหมด",
    ...
    "os_help_macos"   => "มีสองอิมเมจ: หนึ่งสำหรับ Apple Silicon (ซีรีส์ M) และอีกหนึ่งสำหรับ Intel Mac ไม่แน่ใจ? เมนู Apple → เกี่ยวกับ Mac เครื่องนี้",
