...
return [
    ...
    "help_eyebrow" => "ความช่วยเหลือ",
    "help_h1" => "วิธีใช้ dopeIPTV",
    "help_intro" => "คำตอบสั้น ๆ จัดกลุ่มตามสิ่งที่คุณต้องการทำ ค้นหา หรือเปิดหัวข้อ",
    "help_search_ph" => "ค้นหาในความช่วยเหลือ…",
    "help_toc" => "หัวข้อ",
    "help_no_hits" => "ไม่พบสิ่งที่ตรงกัน ลองคำที่สั้นลง หรือถามบน GitHub",
];
