...
return [
    ...
    // ---- Help page ----
    "nav_help" => "Справка",
    "help_eyebrow" => "Справка",
    "help_h1" => "Как пользоваться dopeIPTV",
    "help_intro" => "Короткие ответы, сгруппированные по задачам. Ищите или откройте раздел.",
    "help_search_ph" => "Поиск по справке…",
    "help_toc" => "Разделы",
    "help_no_hits" => "Ничего не найдено. Попробуйте слово покороче или спросите на GitHub.",
];
