...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "menu_multiview": {
        "en": "Multiview", "sv": "Multiview", "es": "Multivista",
        "de": "Multiview", "fr": "Multivue", "zh": "多画面",
        "ru": "Мультиэкран", "th": "มัลติวิว",
    },
    "menu_playlists": {
        "en": "Playlists", "sv": "Spellistor", "es": "Listas",
        "de": "Wiedergabelisten", "fr": "Listes", "zh": "播放列表",
        "ru": "Плейлисты", "th": "เพลย์ลิสต์",
    },
    "dont_show_again": {
        "en": "Don't show this again", "sv": "Visa inte det här igen",
        "es": "No volver a mostrar esto", "de": "Das nicht mehr anzeigen",
        "fr": "Ne plus afficher ceci", "zh": "不再显示",
        "ru": "Больше не показывать", "th": "ไม่ต้องแสดงข้อความนี้อีก",
    },
    "mv_info_title": {
        "en": "About multiview", "sv": "Om multiview",
        "es": "Acerca de multivista", "de": "Über Multiview",
        "fr": "À propos du multivue", "zh": "关于多画面",
    ...
    "mv_sec_window": {
        "en": "WINDOW", "sv": "FÖNSTER", "es": "VENTANA", "de": "FENSTER",
        "fr": "FENÊTRE", "zh": "窗口", "ru": "ОКНО", "th": "หน้าต่าง",
    },
    "mv_sec_behavior": {
        "en": "BEHAVIOR", "sv": "BETEENDE", "es": "COMPORTAMIENTO",
        "de": "VERHALTEN", "fr": "COMPORTEMENT", "zh": "行为",
        "ru": "ПОВЕДЕНИЕ", "th": "พฤติกรรม",
    },
    "mv_sec_controls": {
        "en": "CONTROLS", "sv": "KONTROLLER", "es": "CONTROLES",
        "de": "STEUERUNG", "fr": "COMMANDES", "zh": "控制",
        "ru": "УПРАВЛЕНИЕ", "th": "การควบคุม",
    },
    "mv_set_titlebar": {
        ...
        "ru": "Показывать заголовок окна", "th": "แสดงแถบชื่อ",
    },
    "mv_set_on_top": {
        "en": "Always on top", "sv": "Alltid överst",
        "es": "Siempre visible", "de": "Immer im Vordergrund",
        "fr": "Toujours au premier plan", "zh": "始终置顶",
        "ru": "Поверх всех окон", "th": "อยู่บนสุดเสมอ",
    },
    "mv_set_remember_geo": {
        "en": "Remember window size and position",
        "sv": "Kom ihåg fönstrets storlek och läge",
        "es": "Recordar tamaño y posición de la ventana",
        "de": "Fenstergröße und -position merken",
        "fr": "Mémoriser la taille et la position de la fenêtre",
        "zh": "记住窗口大小和位置",
        "ru": "Запоминать размер и положение окна",
        "th": "จดจำขนาดและตำแหน่งหน้าต่าง",
    },
    "mv_set_stop_docked": {
        "en": "Stop the main player when sending to multiview",
        "sv": "Stoppa huvudspelaren när du skickar till multiview",
        "es": "Detener el reproductor principal al enviar a multivista",
        "de": "Hauptplayer stoppen, wenn an Multiview gesendet wird",
        "fr": "Arrêter le lecteur principal lors de l'envoi au multivue",
        "zh": "发送到多画面时停止主播放器",
    ...
    "mv_set_conflict": {
        ...
        "es": "Al reproducir aquí con multivista activa",
        "de": "Beim Abspielen hier, während Multiview läuft",
        "fr": "Lecture ici pendant que le multivue est actif",
        "zh": "多画面运行时在此播放",
        "ru": "При воспроизведении здесь, когда работает мультиэкран",
        "th": "เมื่อเล่นที่นี่ขณะมัลติวิวทำงาน",
    },
    "mv_conflict_ask": {
        "en": "Ask every time", "sv": "Fråga varje gång",
        "es": "Preguntar cada vez", "de": "Jedes Mal fragen",
        "fr": "Demander à chaque fois", "zh": "每次询问",
        "ru": "Спрашивать каждый раз", "th": "ถามทุกครั้ง",
    },
    "mv_set_autohide": {
        "en": "Auto-hide controls after (seconds)",
        "sv": "Göm kontroller automatiskt efter (sekunder)",
        "es": "Ocultar controles tras (segundos)",
        "de": "Steuerung automatisch ausblenden nach (Sekunden)",
        "fr": "Masquer les commandes après (secondes)",
        "zh": "控制条自动隐藏（秒）",
        "ru": "Автоскрытие управления через (секунд)",
        "th": "ซ่อนการควบคุมอัตโนมัติหลังจาก (วินาที)",
    },
    "mv_set_seek_step": {
        "en": "Arrow-key timeshift step (minutes)",
        "sv": "Piltangenternas timeshift-steg (minuter)",
        "es": "Salto de timeshift con flechas (minutos)",
        "de": "Timeshift-Schritt der Pfeiltasten (Minuten)",
        "fr": "Pas de timeshift des flèches (minutes)",
        "zh": "方向键时移步长（分钟）",
        "ru": "Шаг таймшифта стрелками (минуты)",
        "th": "ช่วงเลื่อนไทม์ชิฟต์ด้วยปุ่มลูกศร (นาที)",
    },
    "mv_set_reset_info": {
        "en": "Show the multiview info notice again",
        "sv": "Visa multiview-informationen igen",
        "es": "Volver a mostrar el aviso de multivista",
        "de": "Multiview-Hinweis erneut anzeigen",
        "fr": "Réafficher l'avis multivue",
        "zh": "再次显示多画面提示",
        "ru": "Показать уведомление о мультиэкране снова",
        "th": "แสดงประกาศมัลติวิวอีกครั้ง",
    },
    "mv_title": {
