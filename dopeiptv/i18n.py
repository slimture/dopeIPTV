...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "eq_title": {"en": "Equaliser…"},
    "eq_enable": {"en": "Equaliser on"},
    "eq_preset": {"en": "Preset"},
    "eq_preset_flat": {"en": "Flat"},
    "eq_preset_bass": {"en": "Bass boost"},
    "eq_preset_treble": {"en": "Treble boost"},
    "eq_preset_vocal": {"en": "Vocals"},
    "eq_preset_rock": {"en": "Rock"},
    "queue_title": {"en": "Play queue"},
    "queue_add": {"en": "Add to queue"},
    "queue_add_folder": {"en": "Queue everything in here"},
    "queue_play_next": {"en": "Play next"},
    "queue_show": {"en": "Show queue…"},
    "queue_clear": {"en": "Clear queue"},
    "queue_added": {"en": "{n} added to the queue"},
    "vis_title": {"en": "Visualiser"},
    "vis_off": {"en": "Off"},
    "vis_style_bars": {"en": "Bars"},
    "vis_style_spectrum": {"en": "Spectrum"},
    "vis_style_wave": {"en": "Waveform"},
    ...
    "menu_open_video": {"en": "Open video file…"},
    "open_video_title": {"en": "Open a video"},
    "open_video_filter": {"en": "Video files"},
    ...
    "rec_manage_scheduled": {"en": "Scheduled recordings…"},
    "rec_scheduled_title": {"en": "Scheduled recordings"},
    "rec_no_upcoming": {"en": "No upcoming recordings."},
