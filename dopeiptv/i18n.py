...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "setting_tmdb_key_optional": {
        "en": "Your own TMDB key (optional)",
        "sv": "Din egen TMDB-nyckel (valfritt)",
        "es": "Tu propia clave de TMDB (opcional)",
        "de": "Eigener TMDB-Schlüssel (optional)",
        "fr": "Votre propre clé TMDB (facultatif)",
        "zh": "你自己的 TMDB 密钥（可选）",
        "ru": "Свой ключ TMDB (необязательно)",
        "th": "คีย์ TMDB ของคุณเอง (ไม่บังคับ)",
    },
    "tmdb_key_optional_ph": {
        "en": "Leave empty to use the built-in key",
        "sv": "Lämna tomt för att använda den inbyggda nyckeln",
        "es": "Déjalo vacío para usar la clave integrada",
        "de": "Leer lassen, um den integrierten Schlüssel zu verwenden",
        "fr": "Laisser vide pour utiliser la clé intégrée",
        "zh": "留空以使用内置密钥",
        "ru": "Оставьте пустым для встроенного ключа",
        "th": "เว้นว่างไว้เพื่อใช้คีย์ในตัว",
    },
    "tmdb_enter_key": {
