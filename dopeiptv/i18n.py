...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "tooltip_toggle_sidebar": {
        "en": "Show/hide the left column (Ctrl+B)",
        "sv": "Visa/dölj vänsterkolumnen (Ctrl+B)",
        "es": "Mostrar/ocultar la columna izquierda (Ctrl+B)",
        "de": "Linke Spalte ein-/ausblenden (Strg+B)",
        "fr": "Afficher/masquer la colonne de gauche (Ctrl+B)",
        "zh": "显示/隐藏左侧栏 (Ctrl+B)",
        "ru": "Показать/скрыть левую колонку (Ctrl+B)",
        "th": "แสดง/ซ่อนคอลัมน์ซ้าย (Ctrl+B)",
    },
    "tooltip_solo_category": {
        "en": "Show only the active category",
        "sv": "Visa bara den aktiva kategorin",
        "es": "Mostrar solo la categoría activa",
        "de": "Nur die aktive Kategorie anzeigen",
        "fr": "Afficher uniquement la catégorie active",
        "zh": "仅显示当前分类",
        "ru": "Показывать только активную категорию",
        "th": "แสดงเฉพาะหมวดหมู่ที่ใช้งานอยู่",
    },
    "rec_today": {
